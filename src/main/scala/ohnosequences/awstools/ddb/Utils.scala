...
// File licence: https://github.com/ohnosequences/metapasta/blob/master/LICENSE
// Code (temporarily included) from metapasta project // https://github.com/ohnosequences/metapasta/blob/master/src/main/scala/ohnosequences/awstools/ddb/Utils.scala
// Modifications:
// - removed logger param in createTable method
...
object Utils {
   ...
   def createTable(ddb: AmazonDynamoDB,
     ...
     try {
       ...
       println("warning: table " + tableName + " already exists")
       true
     } catch {
